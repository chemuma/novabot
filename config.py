...
OWNER_IDS = [
    111111111,  # owner 1 - جای این را با آیدی واقعی عوض کنید
    222222222,  # owner 2 - جای این را با آیدی واقعی عوض کنید
]

# آیدی عددی گروه سفارشات و گروه رضایت مشتری (با فوروارد یک پیام از گروه به @JsonDumpBot یا مشابه پیدا می‌شود)
ORDERS_GROUP_ID = -1001111111111   # جای این را با آیدی واقعی گروه سفارشات عوض کنید
SATISFACTION_GROUP_ID = -1002222222222  # جای این را با آیدی واقعی گروه رضایت عوض کنید
